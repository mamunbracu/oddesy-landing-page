...
const Banner = () => {
  return (
    <div id="service" className="md:flex lg:flex xl:flex justify-between p-8 bg-mirage-500 dark:bg-pink-900">
      <div className="w-full sm:w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mt-16">
    <h1 className="text-2xl md:text-4xl lg:text-6xl xl:text-5xl mb-8 text-indigo-50 dark:text-yellow-500 font-extrabold">Why You should Choose Us</h1>
    ...
    <button className="bg-pink-900 dark:bg-yellow-500 px-8 py-3 w-full sm:w-auto md:w-auto mb-8 rounded text-2xl text-pink-100">Talk to Us</button>
      </div>
